...
def figure_3_plot(model_data, predicts, save=True):
    ...
    plot_gene(predicts, "YKR039W", axd['up_predicts'], rgen, predicts=True, annotation_loc=None, time_positive_only=True)

    plot_gene(model_data, "YOR063W", axd['down_predicts'], rgen, test_only=True, annotation_loc=(0.65, 0.8))
    plot_gene(predicts, "YOR063W", axd['down_predicts'], rgen, predicts=True, annotation_loc=None, time_positive_only=True)
