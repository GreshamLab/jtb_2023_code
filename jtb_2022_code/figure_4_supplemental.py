...
def figure_4_supplement_1_plot(data, save=True):
    ...
    if save:
        fig.savefig(FIGURE_4_SUPPLEMENTAL_FILE_NAME + "_1.png", facecolor='white')
...
def figure_4_supplement_2_plot(data, save=True):
    ...
    if save:
        fig.savefig(FIGURE_4_SUPPLEMENTAL_FILE_NAME + "_2.png", facecolor='white')
...
def figure_4_supplement_3_plot(save=True):
    ...
    ax_lr.annotate("Static", xy=(0.001, 0.82), xycoords='axes fraction', size=10, weight='bold', rotation=90)
    ax_lr.annotate("Dynamical", xy=(0.001, 0.55), xycoords='axes fraction', size=10, weight='bold', rotation=90)
    ax_lr.annotate("Predictive", xy=(0.001, 0.31), xycoords='axes fraction', size=10, weight='bold', rotation=90)
    ax_lr.annotate("Tuned", xy=(0.001, 0.1), xycoords='axes fraction', size=10, weight='bold', rotation=90)
    ax_lr.axis('off')
    ...
    if save:
        fig.savefig(FIGURE_4_SUPPLEMENTAL_FILE_NAME + "_3.png", facecolor="white")
...
def figure_4_supplement_4_plot(save=True):
    ...
    if save:
        fig.savefig(FIGURE_4_SUPPLEMENTAL_FILE_NAME + "_4.png", facecolor="white")
