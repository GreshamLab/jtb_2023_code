...
def generate_figures():
    ...
    from jtb_2022_code.figure_6_supplemental import (
        figure_6_supplement_1_plot
    )
    ...
    ypd, rapa, ypd_scaler, predictions, tfa_predictions, prediction_gradients = get_elife_model_predictions(
        elife,
        biophysical_model
    )
