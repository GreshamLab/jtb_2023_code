...
# Model files
SUPIRFACTOR_COUNT_MODEL = str(ModelFile("RAPA_COUNT_RNN_MODEL_v2.h5"))
SUPIRFACTOR_VELOCITY_DYNAMICAL_MODEL = str(ModelFile("RAPA_VELOCITY_RNN_MODEL_v2.h5"))
SUPIRFACTOR_DECAY_MODEL = str(ModelFile("RAPA_DECAY_MODEL_v2.h5"))
SUPIRFACTOR_BIOPHYSICAL_MODEL = str(ModelFile("RAPA_BIOPHYSICAL_MODEL_v2.h5"))
